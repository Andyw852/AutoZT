#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gen_step7_finetune.py —— mlff step7：MACE 多头微调（fanout seed-*，GPU/CPU）。

运行位置：超算登录节点，cwd = 材料目录；为 N_COMMITTEE 个 seed 各造一个 seed-<S>/
子目录（submit.sh + 引擎脚本），tf 按 fanout 各 sbatch 一次，作业里跑 mlff_finetune.py。
...
def main():
    ...
    from mlff_model import resolve_model as _rm
    ...
    for s in range(1, n_seeds + 1):
        ...
        cmd = (gpu_export + "python ../../mlff_finetune.py "
        ...
        tpl = mc.resolve_submit(here, "submit_mlff")
