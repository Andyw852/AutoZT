...
bash skill/kl-mlff-cpu/templates/mlff/push_model.sh jzzn /public/home/<user>/software/mlff_models
```
...
autozt -tt kl-mlff-cpu -p <材料> conf --set params.MACE_MODEL_DIR=/public/home/<user>/software/mlff_models
```
