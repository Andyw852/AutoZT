...
def _auto_detect_band_summary():
    ...
    cands = [
        "/public/home/<user>/joint_research_project/huang/%s/POSCAR_B/band/step4_band_plot/band_summary.json" % material,
        "/public/home/<user>/joint_research_project/huang/%s/POSCAR_B/band/step3_band_plot/band_summary.json" % material,
    ]
    for c in cands:
        if os.path.exists(c):
            return c
