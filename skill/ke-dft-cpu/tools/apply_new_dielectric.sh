...
UPDATED=""
for S in /public/home/wangchao/ke_work/$M/ke-dft-cpu/step8_amset/settings.yaml \
         /public/home/wangchao/ke_soc_20260910/$M/ke-dft-cpu/step8_amset/settings.yaml; do
...
if [ "$DO_SUBMIT" = "--submit" ]; then
  for D in /public/home/wangchao/ke_work/$M/ke-dft-cpu/step8_amset \
           /public/home/wangchao/ke_soc_20260910/$M/ke-dft-cpu/step8_amset; do
