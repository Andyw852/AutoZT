#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gen_step6b_wave_full.py —— amset wave → wavefunction.h5（step4b_wave_full）。

与 gen_step6_wave.py（S4_wave）**逐行等价**，只把来源目录换成 step3b_uniform_full
（那个步骤用 ISYM = -1 产出完整网格的 WAVECAR），标签换成 S4b_wavefull。
默认关闭（optional_steps.wavefunction_full.default = false），不影响原 S3/S4。

原 gen_step4_wave.py 说明：
...
# =========================== 可改参数区 ===========================
OUTDIR_NAME = "step4b_wave_full"
UNIFORM_DIR = "step3b_uniform_full"
STEP_LABEL  = "S4b_wavefull"
