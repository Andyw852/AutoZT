...
| 组件 | 路径 |
|---|---|
| HamGNN 仓库 | /home/<user>/software/Uni-HamGNN/HamGNN（已 setup.py 装进 ML 环境）|
| 通用模型 | /home/<user>/software/Uni-HamGNN/uni-hamgnn_2_1.pkl（927 MB）|
| DFT_DATA19 | /home/<user>/software/Uni-HamGNN/DFT_DATA19（取自 OpenMX 4.0 GPU 包）|
...
| CONDA_SH / CONDA_ENV | 3090 = /home/<user>/miniconda3/... + ML |
