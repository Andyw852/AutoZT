#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""mlff_model.py —— MACE 模型定位 + ASE calculator 构造。

**在 conda 环境（有 torch / mace-torch）里被 mlff_relax.py / mlff_forces.py import。**
...
def ase_to_phonopy(atoms):
    ...
    [UPSTREAM-FROM-MLFF] 由 skill/mlff 上游化：mlff 的 fc2_calib/
