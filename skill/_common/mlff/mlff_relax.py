#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""mlff_relax.py —— 用 MACE 势弛豫原胞（step1_mlff_relax 的实际干活脚本）。

**在 conda 环境里跑**，cwd = step1_mlff_relax/，读本目录 POSCAR，写 CONTCAR +
...
def main():
    ...
    if as_bool(a.relax):
        ...
        # fix-klmlff：target 是 FrechetCellFilter，get_forces() 会把应力也拼进
