...
```
phonoagent -tt kl-mace-cpu -p <材料> conf --set params.MACE_MODEL=mace-mpa-0-medium.model
phonoagent -tt kl-mace-cpu -p <材料> conf --set params.MACE_MODEL_DIR=/public/home/wangchao/software/mace_models
```
