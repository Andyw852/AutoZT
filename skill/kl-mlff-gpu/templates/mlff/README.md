...
```bash
# 本地：模型下载/训练完丢进本目录
ls skill/kl-mlff-gpu/templates/mlff/
#   mace-mpa-0-medium.model
#   my-finetuned-C60.model

# 一次性推到超算（本目录的 push_model.sh 就干这个）
bash skill/kl-mlff-gpu/templates/mlff/push_model.sh jzzn /public/home/wangchao/software/mlff_models
```
...
autozt -tt kl-mlff-gpu -p <材料> conf --set params.MACE_MODEL_DIR=/public/home/wangchao/software/mlff_models
```
