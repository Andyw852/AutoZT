#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gen_step2_mlff_static.py —— MACE 静态单点（step2_mlff_static），submit 模式。

接力 step1_mlff_relax 的 CONTCAR，写 submit.sh 把静态单点放到计算节点作业里跑。
...
OUTDIR = "step2_mlff_static"
STEP = "step2_mlff_static"
PREV = ["step1_mlff_relax"]
