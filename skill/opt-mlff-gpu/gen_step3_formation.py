...
读 step2_mlff_static 的总能 + 组分 + step.conf 的参考化学势 MU，算
...
def model_identity(desc):
    """把 mlff_model.build_calculator 的描述串压成可比对的 (模型名, dtype)。

    'file:/opt/mlff_models/MACE-xxx.model device=cpu dtype=float64'
