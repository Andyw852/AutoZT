    ...
    *,
    ...
    data = {
        ...
        "policy": {
            ...
            "cycle_default_actions": sorted(protocol.ALLOWED_ACTIONS - {"prepare_step"}),
            "retry": {"allowed": True, "default": "review", "action": "prepare_step", "opt_in": "include_retry"},
    ...
    return {
        ...
        "conversation": {
            ...
            "research_plan": {
                ...
                "action_surface": "separates MCP-safe actions from CLI-only or human-reviewed actions",
            },
        },
...
def schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "actions": {"schema": action_schema,
                    "automatic": sorted(protocol.ALLOWED_ACTIONS - {"prepare_step"}),
                    "retry": {"name": "prepare_step", "requires": "include_retry=true or explicit selection",
                              "keeps_products": True},
